...
%SUPER IMPORTANT:  length of counts is number of genomes + 1.  The first entry 
%should be a zero.
...
gene_freq_histogram_predicted_strains = size(counts, 2) - 1;
new_core_genes_predicted_strains = size(counts, 2) * 20;
